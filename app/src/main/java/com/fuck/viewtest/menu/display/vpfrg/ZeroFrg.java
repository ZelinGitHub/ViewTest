package com.fuck.viewtest.menu.display.vpfrg;
...
public class ZeroFrg extends Fragment {
    private final String TAG="ZeroFrg";
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        return inflater.inflate(R.layout.frg_zero,container,false);
    }
